...
import { updateEvaluationData } from '@/features/evaluations/validations/updateEvaluationSchema';
import { GraduationCap } from 'lucide-react';
import { Control, Controller } from 'react-hook-form';

interface EvaluationInformationsSectionProps {
    control: Control<updateEvaluationData>;
    type_evaluations: string[];
}

const EvaluationEditInformationsSection = ({
    control,
    type_evaluations,
...
export default EvaluationEditInformationsSection;
