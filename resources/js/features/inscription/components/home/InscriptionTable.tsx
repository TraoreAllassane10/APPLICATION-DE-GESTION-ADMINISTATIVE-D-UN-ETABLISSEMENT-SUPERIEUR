...
import { ChevronDown, Folder, GraduationCap, Trash2 } from 'lucide-react';
                                ...
                                {isAdmin && (
                                    <>
                                        <TableCell className="text-sm font-medium tabular-nums">
                                            {ins.taux_reduction > 0
                                                ? ins.taux_reduction + '%'
                                                : '-'}
                                        </TableCell>
                                        <TableCell className="text-sm font-medium tabular-nums">
                                            {ins.montant_reduction
                                                ? fmt(ins.montant_reduction)
                                                : '-'}
                                        </TableCell>
                                        <TableCell>
                                            <ProgressFinanciere
