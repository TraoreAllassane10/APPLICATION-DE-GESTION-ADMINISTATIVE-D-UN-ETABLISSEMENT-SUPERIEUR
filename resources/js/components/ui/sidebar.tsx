  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-slate-950 text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col",
          className
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-slate-950 text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="bg-slate-950 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
